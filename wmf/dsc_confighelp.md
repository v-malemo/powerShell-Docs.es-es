...
En primer lugar, definimos dos funciones de configuración denominadas HelpSample1 y HelpSample2, con la ayuda basada en comentarios incluida en cada una de ellas:
...
Para obtener ayuda sobre HelpSample1, simplemente ejecute:
...
También puede obtener ayuda detallada sobre el uso de Get-Help:
